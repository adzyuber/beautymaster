const messages = {
  ru: {
    ...
    'account.myAdsHint': 'Управление и статусы ваших объявлений',
    'account.createShort': 'Создать',
    'account.deleteAdTitle': 'Удалить объявление?',
    'account.deleteAdDesc': 'Объявление «{title}» будет удалено навсегда. Это действие нельзя отменить.',
    'account.createAd': 'Создать объявление',
    'account.createAdHint': 'Опубликовать новое предложение',
    'account.messages': 'Сообщения',
    'account.messagesHint': 'Переписки с клиентами и специалистами',
    'account.favoritesHint': 'Сохранённые объявления',
    'account.adminPanelHint': 'Модерация, категории и пользователи',
    'account.email': 'Email',
    'account.hub.completeness': 'Профиль заполнен',
    'account.hub.completenessHint': 'Чем полнее профиль, тем больше доверия у клиентов',
    'account.hub.addAvatar': 'Добавить фото',
    'account.hub.addPhone': 'Добавить телефон',
    'account.hub.addOrg': 'Указать организацию',
    'account.hub.addWebsite': 'Добавить сайт',
    'account.hub.addLanguages': 'Указать языки',
    'account.hub.statsAds': 'Активных',
    'account.hub.statsMessages': 'Сообщений',
    'account.hub.statsFavorites': 'В избранном',
    'account.hub.statsNotifications': 'Уведомлений',
    'account.hub.adsPending': '{n} на проверке',
    'account.hub.adsTotal': 'Всего {n}',
    'account.hub.adsNone': 'Пока нет объявлений',
    'account.hub.unread': 'Есть непрочитанные',
    'account.hub.upToDate': 'Всё прочитано',
    'account.hub.favoritesSaved': 'Сохранённые объявления',
    'account.hub.favoritesNone': 'Пока ничего',
    'account.edit.title': 'Редактировать профиль',
    'account.edit.back': 'Назад',
    'account.edit.photoSection': 'Фото профиля',
    'account.edit.photoHint': 'Квадратное изображение, JPG или PNG, лицо в центре',
    'account.edit.personalSection': 'Личные данные',
    'account.edit.businessSection': 'Контакты и организация',
    'account.edit.unsaved': 'Есть несохранённые изменения',
    'account.edit.allSaved': 'Всё сохранено',
    'account.settings.title': 'Настройки',
    'account.settings.appearance': 'Внешний вид',
    'account.settings.account': 'Аккаунт',
    'account.settings.languageHint': 'Язык интерфейса BeautyMaster',
    'account.settings.editHint': 'Имя, телефон, фото, организация',
    'account.settings.logoutHint': 'Завершить сеанс на этом устройстве',
    ...
    'account.fixAndResubmit': 'Исправить и отправить снова',
    'account.dialogs': 'Диалоги',
    'account.noDialogs': 'Нет диалогов',
    'account.noDialogsDesc': 'Здесь появятся ваши переписки со специалистами и клиентами',
    ...
    'account.deleteChat': 'Удалить переписку',
    'account.deleteChatTitle': 'Удалить переписку?',
    'account.deleteChatDesc': 'Переписка с {name} будет удалена только у вас. Если придут новые сообщения, чат снова появится.',
  ...
  en: {
    ...
    'account.myAdsHint': 'Manage your listings and their status',
    'account.createShort': 'Create',
    'account.deleteAdTitle': 'Delete listing?',
    'account.deleteAdDesc': 'Listing "{title}" will be removed permanently. This cannot be undone.',
    'account.createAd': 'Create listing',
    'account.createAdHint': 'Publish a new offer',
    'account.messages': 'Messages',
    'account.messagesHint': 'Chats with clients and specialists',
    'account.favoritesHint': 'Your saved listings',
    'account.adminPanelHint': 'Moderation, categories and users',
    'account.email': 'Email',
    'account.hub.completeness': 'Profile complete',
    'account.hub.completenessHint': 'A complete profile builds trust with clients',
    'account.hub.addAvatar': 'Add photo',
    'account.hub.addPhone': 'Add phone',
    'account.hub.addOrg': 'Add organization',
    'account.hub.addWebsite': 'Add website',
    'account.hub.addLanguages': 'Add languages',
    'account.hub.statsAds': 'Active',
    'account.hub.statsMessages': 'Messages',
    'account.hub.statsFavorites': 'Favorites',
    'account.hub.statsNotifications': 'Notifications',
    'account.hub.adsPending': '{n} pending review',
    'account.hub.adsTotal': '{n} total',
    'account.hub.adsNone': 'No listings yet',
    'account.hub.unread': 'You have unread',
    'account.hub.upToDate': 'All caught up',
    'account.hub.favoritesSaved': 'Saved listings',
    'account.hub.favoritesNone': 'Nothing saved yet',
    'account.edit.title': 'Edit profile',
    'account.edit.back': 'Back',
    'account.edit.photoSection': 'Profile photo',
    'account.edit.photoHint': 'Square image, JPG or PNG, face centered',
    'account.edit.personalSection': 'Personal details',
    'account.edit.businessSection': 'Contact and organization',
    'account.edit.unsaved': 'You have unsaved changes',
    'account.edit.allSaved': 'All changes saved',
    'account.settings.title': 'Settings',
    'account.settings.appearance': 'Appearance',
    'account.settings.account': 'Account',
    'account.settings.languageHint': 'BeautyMaster interface language',
    'account.settings.editHint': 'Name, phone, photo, organization',
    'account.settings.logoutHint': 'End session on this device',
    ...
    'account.fixAndResubmit': 'Fix and resubmit',
    'account.dialogs': 'Chats',
    'account.noDialogs': 'No chats yet',
    'account.noDialogsDesc': 'Your conversations with specialists and clients will appear here',
    ...
    'account.deleteChat': 'Delete chat',
    'account.deleteChatTitle': 'Delete chat?',
    'account.deleteChatDesc': 'The chat with {name} will be removed only for you. If new messages arrive, the chat will reappear.',
