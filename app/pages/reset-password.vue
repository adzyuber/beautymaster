  ...
  <AuthShell :title="t('reset.title')" :subtitle="t('reset.subtitle')">
    ...
    <form v-else @submit.prevent="submit" class="space-y-4">
      <div>
        ...
        <div class="relative">
          <input v-model="form.password" :type="showPassword ? 'text' : 'password'" required minlength="6" autocomplete="new-password"
      ...
      <div>
        ...
        <input v-model="form.confirm" type="password" required minlength="6" autocomplete="new-password"
          class="w-full rounded border border-gray-200 bg-white px-4 py-3.5 text-[15px] text-[#2D2D2D] transition-colors focus:border-[#1EC3BD] focus:outline-none focus:ring-4 focus:ring-[#1EC3BD]/25">
      </div>
