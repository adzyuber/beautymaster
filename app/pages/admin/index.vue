<template>
  ...
  <div v-else class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
      ...
      <NuxtLink to="/admin/languages"
        class="bg-white rounded shadow-[0_2px_16px_rgba(45,77,58,0.07)] p-8 hover:shadow-md transition-shadow group">
        <div class="text-4xl mb-3">🌐</div>
        <div class="text-lg font-bold text-[#2D4D3A] group-hover:underline">Languages</div>
        <div class="text-sm text-[#5B5B5B] mt-1">Configure the spoken-language list and the default</div>
      </NuxtLink>
