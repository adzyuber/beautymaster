...
const hideOnRoutes = ['/account/messages', '/account/create', '/privacy', '/account/settings']
const isHidden = computed(() => hideOnRoutes.includes(route.path) || route.path.startsWith('/ad/') || route.path.startsWith('/account/profile'))
